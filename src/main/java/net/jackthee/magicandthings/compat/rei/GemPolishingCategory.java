...
public class GemPolishingCategory implements DisplayCategory<BasicDisplay> {
    public static final Identifier TEXTURE = new Identifier(MagicAndThings.MOD_ID,"textures/gui/gem_polishing_station_gui.png");
    public static final CategoryIdentifier<GemPolishingDisplay> GEM_POLISHING =
            CategoryIdentifier.of(MagicAndThings.MOD_ID,"gem_polishing");
